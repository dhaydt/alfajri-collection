                                    ...
                                    <div class="col-md-6">
                                        <center>
                                            <img
                                                ...
                                                id="mbImageviewer"
                                                src="<?php echo e(asset('assets\back-end\img\400x400\img1.jpg')); ?>"
                                                alt="banner image"/>
                                        </center>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <center>
                                            <img
                                                style="width: auto;border: 1px solid; border-radius: 10px; max-height:200px;"
                                                id="fbImageviewer"
                                                src="<?php echo e(asset('assets\back-end\img\400x400\img2.jpg')); ?>"
                                                alt="banner image"/>
                                        </center>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.back-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mh/code/Pak etek/alfajri/resources/views/admin-views/banner/view.blade.php ENDPATH**/ ?>