    ...
    <div class="container text-center" style="padding-bottom: 13px;">
        ...
        <div
            ...
            <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mt-3">
                <h6 class="text-uppercase mb-2 font-weight-bold footer-heder"><?php echo e(\App\CPU\translate('Alfajri')); ?></h6>
                ...
                <h6 class="text-uppercase mb-3 font-weight-bold footer-heder"><?php echo e(\App\CPU\translate('payment_method')); ?></h6>
                    <ul class="widget-list" style="padding-bottom: 10px">
                        <li class="widget-list-item"><a class="mr-2 bank-logo" href="javascript:void(0)" role="button"><img
                            src="<?php echo e(asset("assets/front-end/img/bca-ready.png")); ?>"
                            alt="payment">
                    </a><a class="mr-2 bank-logo" href="javascript:void(0)" role="button"><img
                            src="<?php echo e(asset("assets/front-end/img/mandiri-ready.png")); ?>"
                            alt="payment">
                    </a><a class="mr-2 bank-logo" href="javascript:void(0)" role="button"><img
                            src="<?php echo e(asset("assets/front-end/img/bri-ready.png")); ?>"
                            alt="payment">
                    </a><a class="mr-2 bank-logo" href="javascript:void(0)" role="button"><img
                            src="<?php echo e(asset("assets/front-end/img/bni-ready.png")); ?>"
                            alt="payment">
                    </a>
                    <a class="bank-logo" href="javascript:void(0)" role="button"><img class="pt-2 mt-1"
                            src="<?php echo e(asset("assets/front-end/img/cimb-ready.png")); ?>"
                            alt="payment">
                    </a>
                        </li>
                        <li class="widget-list-item mt-3">
                            <a class="mr-2 bank-logo" href="javascript:void(0)" role="button"><img
                                src="<?php echo e(asset("assets/front-end/img/ovo-ready.png")); ?>"
                                alt="payment">
                        </a><a class="mr-2 bank-logo" href="javascript:void(0)" role="button"><img
                                src="<?php echo e(asset("assets/front-end/img/dana-ready.png")); ?>"
                                alt="payment">
                        </a>
                        <a class="mr-2 bank-logo" href="javascript:void(0)" role="button"><img
                            src="<?php echo e(asset("assets/front-end/img/link-ready.png")); ?>"
                            alt="payment">
                        </a>
                        <a class="mr-2 bank-logo" href="javascript:void(0)" role="button"><img
                            src="<?php echo e(asset("assets/front-end/img/shopee-ready.png")); ?>"
                            alt="payment">
                        </a>
                        </li>
                        ...
                        <li class="widget-list-item mt-3">
                            <a class="mr-2 bank-logo" href="javascript:void(0)" role="button"><img
                                src="<?php echo e(asset("assets/front-end/img/qris-ready.png")); ?>"
                                alt="payment">
                        </a>
                            <a class="mr-2 bank-logo" href="javascript:void(0)" role="button"><img
                            src="<?php echo e(asset("assets/front-end/img/indo-ready.png")); ?>"
                            alt="payment">
                    </a><a class="mr-2 bank-logo" href="javascript:void(0)" role="button"><img
                            src="<?php echo e(asset("assets/front-end/img/alfa-ready.png")); ?>"
                            alt="payment">
                    </a>
                        </li>
                ...
                <div class="text-nowrap mb-4">
                    <a class="d-inline-block mt-n1" href="<?php echo e(route('home')); ?>">
                        <img width="250" style="height: 60px!important;"
                             src="<?php echo e(asset("storage/company/")); ?>/<?php echo e($web_config['footer_logo']->value); ?>"
                        ...
                        <?php if($android['status']): ?>
                            <div class="<?php echo e(Session::get('direction') === "rtl" ? 'ml-2' : 'mr-2'); ?> mb-2">
                                <a href="<?php echo e($android['link']); ?>" role="button">
                                    <img src="<?php echo e(asset("assets/front-end/png/google_app.png")); ?>"
                                         alt="" style="height: 40px!important;">
                                </a>
                            </div>
                        <?php endif; ?>
...
<!-- Footer -->
<?php /**PATH /home/mh/code/Pak etek/alfajri/resources/views/layouts/front-end/partials/_footer.blade.php ENDPATH**/ ?>