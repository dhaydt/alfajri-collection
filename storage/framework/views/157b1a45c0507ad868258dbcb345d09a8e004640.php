...
<head>
    ...
    <title><?php echo e(\App\CPU\translate('New order received')); ?></title>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" id="emailContainer"
                ...
                <tr>
                    ...
                    <td align="left" valign="top" colspan="2"
                        ...
                        <span style="font-size: 18px; font-weight: normal;"><?php echo e(\App\CPU\translate('Notification mail for new order received')); ?></span>
                    </td>
                ...
                <tr>
                    ...
                    <td align="left" valign="top" colspan="2" style="padding-top: 10px;">
                        ...
                        <span style="font-size: 12px; line-height: 1.5; color: #333333;">
                            ...
                            <?php echo e(\App\CPU\translate('We have sent you this email to notify that you have a new order. You will be able to see your orders after login to your panel')); ?>.

                            <br/><br/>

                            <?php echo e(\App\CPU\translate('New order ID for you')); ?> :
...
<?php /**PATH /home/mh/code/project.co/Tigatech/umkm-shop/resources/views/email-templates/order-received-notify-seller.blade.php ENDPATH**/ ?>