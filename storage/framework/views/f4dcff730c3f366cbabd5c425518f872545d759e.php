...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180"
          href="<?php echo e(asset('storage/company')); ?>/<?php echo e($web_config['fav_icon']->value); ?>">
    <link rel="icon" type="image/png" sizes="32x32"
          href="<?php echo e(asset('storage/company')); ?>/<?php echo e($web_config['fav_icon']->value); ?>">

    <link rel="stylesheet" media="screen"
          href="<?php echo e(asset('assets/front-end')); ?>/vendor/simplebar/dist/simplebar.min.css"/>
    <link rel="stylesheet" media="screen"
          href="<?php echo e(asset('assets/front-end')); ?>/vendor/tiny-slider/dist/tiny-slider.css"/>
    <link rel="stylesheet" media="screen"
          href="<?php echo e(asset('assets/front-end')); ?>/vendor/drift-zoom/dist/drift-basic.min.css"/>
    <link rel="stylesheet" media="screen"
          href="<?php echo e(asset('assets/front-end')); ?>/vendor/lightgallery.js/dist/css/lightgallery.min.css"/>
    <link rel="stylesheet" href="<?php echo e(asset('assets/back-end')); ?>/css/toastr.css"/>
    <!-- Main Theme Styles + Bootstrap-->
    <link rel="stylesheet" media="screen" href="<?php echo e(asset('assets/front-end')); ?>/css/theme.min.css">
    <link rel="stylesheet" media="screen" href="<?php echo e(asset('assets/front-end')); ?>/css/slick.css">
    <link rel="stylesheet" media="screen" href="<?php echo e(asset('assets/front-end')); ?>/css/font-awesome.min.css">
    <!--    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">-->
    <link rel="stylesheet" href="<?php echo e(asset('assets/back-end')); ?>/css/toastr.css"/>
    <link rel="stylesheet" href="<?php echo e(asset('assets/front-end')); ?>/css/master.css"/>
    <link
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/front-end')); ?>/css/home.css"/>
    <link rel="stylesheet" href="<?php echo e(asset('assets/front-end')); ?>/css/responsive1.css"/>
...
<header class="box-shadow-sm rtl d-block d-md-none">
    <?php echo $__env->make('layouts.front-end.partials._mobile_header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</header>
<!-- Page title-->
    ...
    <div class="row">
        <div class="col-12" style="width:85%;position: fixed;z-index: 9999;display: flex;align-items: center;justify-content: center;">
            <div id="loading" style="display: none">
                <img width="200"
                     src="<?php echo e(asset('storage/company')); ?>/<?php echo e(\App\CPU\Helpers::get_business_settings('loader_gif')); ?>"
                     onerror="this.src='<?php echo e(asset('assets/front-end/img/loader.gif')); ?>'">
            </div>
        </div>
    </div>
</div>
...
<script src="<?php echo e(asset('assets/front-end')); ?>/vendor/jquery/dist/jquery-2.2.4.min.js"></script>
<script src="<?php echo e(asset('assets/front-end')); ?>/vendor/bootstrap/dist/js/bootstrap.bundle.min.js"></script>
<script
    src="<?php echo e(asset('assets/front-end')); ?>/vendor/bs-custom-file-input/dist/bs-custom-file-input.min.js"></script>
<script src="<?php echo e(asset('assets/front-end')); ?>/vendor/simplebar/dist/simplebar.min.js"></script>
<script src="<?php echo e(asset('assets/front-end')); ?>/vendor/tiny-slider/dist/min/tiny-slider.js"></script>
<script src="<?php echo e(asset('assets/front-end')); ?>/vendor/smooth-scroll/dist/smooth-scroll.polyfills.min.js"></script>

<script src="<?php echo e(asset('assets/front-end')); ?>/vendor/drift-zoom/dist/Drift.min.js"></script>
<script src="<?php echo e(asset('assets/front-end')); ?>/vendor/lightgallery.js/dist/js/lightgallery.min.js"></script>
<script src="<?php echo e(asset('assets/front-end')); ?>/vendor/lg-video.js/dist/lg-video.min.js"></script>

<script src=<?php echo e(asset("assets/back-end/js/toastr.js")); ?>></script>
<!-- Main theme script-->
<script src="<?php echo e(asset('assets/front-end')); ?>/js/theme.min.js"></script>
<script src="<?php echo e(asset('assets/front-end')); ?>/js/slick.min.js"></script>
<script src="<?php echo e(asset('assets/front-end')); ?>/js/jquery-touchswipe.js"></script>

<script src="<?php echo e(asset('assets/front-end')); ?>/js/sweet_alert.js"></script>
...
<script>
    ...
    function closeBanHeader(){
        ...
        $.ajax({
            url: "<?php echo e(route('closeBanner')); ?>",
            method: 'GET'
        });
    };
        ...
        $('.input-number').change(function () {
            ...
            if (valueCurrent >= minValue) {
                ...
                Swal.fire({
                    icon: 'error',
                    title: 'Cart',
                    text: '<?php echo e(\App\CPU\translate('Sorry, the minimum value was reached')); ?>'
                });
...
<script>
    ...
    img.addEventListener("error", function (event) {
        event.target.src = '<?php echo e(asset('assets/front-end/img/image-place-holder.png')); ?>';
        event.onerror = null
    })
...
<?php /**PATH /home/mh/code/Pak etek/alfajri/resources/views/layouts/front-end/app.blade.php ENDPATH**/ ?>