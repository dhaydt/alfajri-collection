...
<div id="floating" style="position: fixed; right: 0px; bottom: 65px; width: 80px;height: 80px;">
    ...
    <a href="javascript:" class="chatus" id="test">
        <img class="float-img" src="<?php echo e(asset('storage/banner')); ?>/<?php echo e($floating['photo']); ?>" alt="floating">
    </a>
</div>
<?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/mh/code/Pak etek/alfajri/resources/views/web-views/partials/_floating.blade.php ENDPATH**/ ?>