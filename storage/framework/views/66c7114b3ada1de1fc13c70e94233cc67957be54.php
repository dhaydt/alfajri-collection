<script src="<?php echo e(asset('assets/back-end/js/croppie.js')); ?>"></script>
<script>
...
<script>
    ...
    $('#image-set-<?php echo e($id); ?>').on('change', function () {
        ...
        if (file1 == 1) {
            ...
            $(this).val('');
            toastr.error('<?php echo e(\App\CPU\translate('This is not an image file')); ?>.', {
                CloseButton: true,
                ProgressBar: true
            });
        } else {
...
<?php /**PATH /home/mh/code/Pak etek/alfajri/resources/views/shared-partials/image-process/_script.blade.php ENDPATH**/ ?>