                        ...
                        <div class="row">
                            ...
                            <div class="col-6 pt-2">
                                <div class="text-right">
                                    ...
                                    <h6 class="" style="color: #8a8a8a;">
                                        <?php echo e(\App\CPU\translate('delivery')); ?> <?php echo e(\App\CPU\translate('date')); ?>

                                        : <span style="color: #000; font-weight: 600;"><?php echo e(date('j F, Y',strtotime($order->delivery_date ? $order->delivery_date : 'Tidak ada Tanggal'))); ?></span>
                                    </h6>
                                    <?php endif; ?>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.back-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mh/code/project.co/Tigatech/umkm-shop/resources/views/admin-views/order/order-details.blade.php ENDPATH**/ ?>