        ...
        <div class="modal-content" style="width: <?php echo e($width+66); ?>px;margin-left: <?php echo e($margin_left); ?>">
            ...
            <div class="modal-body">
                ...
                <div class="alert alert-block alert-success" id="img-suc-<?php echo e($modal_id); ?>"
                    ...
                    <strong class="green">
                        <?php echo e(\App\CPU\translate('Image uploaded successfully')); ?>.
                    </strong>
                </div>
                ...
                <div class="alert alert-block alert-danger" id="img-err-<?php echo e($modal_id); ?>"
                     style="display: none;">
                    <strong class="red">
                        <?php echo e(\App\CPU\translate('Error , Something went wrong')); ?> !
                    </strong>
                </div>
                ...
                <form>
                    ...
                    <div class="form-group" id="select-img-<?php echo e($modal_id); ?>">
                        <label for="image-set-<?php echo e($modal_id); ?>" class="custom-file-upload">
                            <?php echo e(\App\CPU\translate('Choose Image')); ?> <i class="fa fa-plus-circle"></i>
                        </label>
...
<?php /**PATH /home/mh/code/project.co/Tigatech/umkm-shop/resources/views/shared-partials/image-process/_image-crop-modal.blade.php ENDPATH**/ ?>