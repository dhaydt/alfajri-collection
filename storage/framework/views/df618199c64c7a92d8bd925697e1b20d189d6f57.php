...
<div class="navbar-tool dropdown <?php echo e(Session::get('direction') === "rtl" ? 'mr-3' : 'ml-3'); ?>"
    ...
    <a class="navbar-tool-icon-box bg-secondary dropdown-toggle" href="<?php echo e(route('shop-cart')); ?>">
        ...
        <input type="hidden" id="cartCount" value="<?php echo e($cart->count()); ?>">
...
<?php /**PATH /home/mh/code/project.co/Tigatech/Ongoing/grosa/resources/views/layouts/front-end/partials/cart.blade.php ENDPATH**/ ?>