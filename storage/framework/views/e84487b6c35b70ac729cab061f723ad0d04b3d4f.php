                            ...
                            <div class="card-body" style="padding: 20px">
                                <center>
                                    <img width="233" id="viewerWFS"
                                         onerror="this.src='<?php echo e(asset('public/assets/front-end/img/image-place-holder.png')); ?>'"
                                         src="<?php echo e(asset('storage/app/public/company')); ?>/<?php echo e(\App\Model\BusinessSetting::where(['type' => 'flash_sale_banner'])->pluck('value')[0]); ?>">
                                </center>
                                <hr>
                                <div class="row pl-4 pr-4">
                                    <div class="col-12" style="text-align: left">
...
<?php echo $__env->make('layouts.back-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mh/code/project.co/Tigatech/umkm-shop/resources/views/admin-views/business-settings/website-info.blade.php ENDPATH**/ ?>