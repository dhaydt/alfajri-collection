        ...
        <div class="page-header mb-1">
            <div class="flex-between align-items-center">
                ...
                <div class="d-flex justify-content-between">
                    <form action="<?php echo e(url()->current()); ?>" id="sort-range" method="GET" class="d-flex">
                        
                        <div class="input-group">
                            <div class="input-group-prepend">
                            <span class="input-group-text" id="basic-addon1"><?php echo e(\App\CPU\translate('start_date')); ?></span>
                            </div>
                            <input type="text" autocomplete="off" value="<?php echo e($start); ?>" name="start-date" required class="form-control dated" id="start-date" aria-describedby="basic-addon1">
                        </div>
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <span class="input-group-text" id="basic-addon2"><?php echo e(\App\CPU\translate('end_date')); ?></span>
                            </div>
                            <input type="text" autocomplete="off" value="<?php echo e($end); ?>" name="end-date" required class="form-control dated" id="end-date" aria-describedby="basic-addon2">
                        </div>
                        <button class="btn btn-primary btn-sm mx-3" type="submit">Filter</button>
                    </form>
                    <form action="<?php echo e(route('admin.export')); ?>" method="GET" class="d-flex">
            ...
            <div class="table-responsive datatable-custom">
                <table class="table table-hover table-borderless table-thead-bordered table-nowrap table-align-middle card-table"
                    ...
                    <tr>
                        ...
                        <th><?php echo e(\App\CPU\translate('delivery_date')); ?></th>
...
<?php echo $__env->make('layouts.back-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mh/code/project.co/Tigatech/umkm-shop/resources/views/admin-views/order/list.blade.php ENDPATH**/ ?>