<div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
    <!-- Card -->
    <a class="card card-hover-shadow h-100" href="<?php echo e(route('admin.orders.list',['pending'])); ?>" style="background: #3E215D">
        <div class="card-body">
            <div class="flex-between align-items-center mb-1">
                <div style="text-align: <?php echo e(Session::get('direction') === "rtl" ? 'right' : 'left'); ?>;">
                    <h6 class="card-subtitle" style="color: white!important;"><?php echo e(\App\CPU\translate('pending')); ?></h6>
...
<div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
    <!-- Card -->
    <a class="card card-hover-shadow h-100" href="<?php echo e(route('admin.orders.list',['confirmed'])); ?>" style="background: #001E6C">
        <div class="card-body">
            <div class="flex-between align-items-center mb-1">
                <div style="text-align: <?php echo e(Session::get('direction') === "rtl" ? 'right' : 'left'); ?>;">
                    <h6 class="card-subtitle" style="color: white!important;"><?php echo e(\App\CPU\translate('confirmed')); ?></h6>
                     <span class="card-title h2" style="color: white!important;">
    ...
    <a class="card card-hover-shadow h-100" href="<?php echo e(route('admin.orders.list',['processing'])); ?>" style="background: #053742">
        <div class="card-body">
            <div class="flex-between align-items-center gx-2 mb-1">
                <div style="text-align: <?php echo e(Session::get('direction') === "rtl" ? 'right' : 'left'); ?>;">
                    <h6 class="card-subtitle" style="color: white!important;"><?php echo e(\App\CPU\translate('Processing')); ?></h6>
                    <span class="card-title h2" style="color: white!important;">
...
<div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
    ...
    <a class="card card-hover-shadow h-100" href="<?php echo e(route('admin.orders.list',['out_for_delivery'])); ?>" style="background: #343A40">
        <div class="card-body">
            <div class="flex-between align-items-center gx-2 mb-1">
                <div style="text-align: <?php echo e(Session::get('direction') === "rtl" ? 'right' : 'left'); ?>;">
                    <h6 class="card-subtitle" style="color: white!important;"><?php echo e(\App\CPU\translate('out_for_delivery')); ?></h6>
                    <span class="card-title h2" style="color: white!important;">
        ...
        <div class="row gx-lg-4">
            <div class="col-sm-6 col-lg-3">
                <div class="media flex-between align-items-center" style="cursor: pointer"
                    ...
                    <div class="media-body" style="text-align: <?php echo e(Session::get('direction') === "rtl" ? 'right' : 'left'); ?>;">
                        ...
                        <span class="card-title h3"><?php echo e($data['delivered']); ?></span>
                    </div>
                    <div>
            ...
            <div class="col-sm-6 col-lg-3 column-divider-sm">
                <div class="media flex-between align-items-center" style="cursor: pointer"
                    ...
                    <div class="media-body" style="text-align: <?php echo e(Session::get('direction') === "rtl" ? 'right' : 'left'); ?>;">
                        <h6 class="card-subtitle"><?php echo e(\App\CPU\translate('canceled')); ?></h6>
                        <span class="card-title h3"><?php echo e($data['canceled']); ?></span>
                    </div>
                    <span class="icon icon-sm icon-soft-secondary icon-circle ml-3">
            ...
            <div class="col-sm-6 col-lg-3 column-divider-lg">
                <div class="media flex-between align-items-center" style="cursor: pointer"
                    ...
                    <div class="media-body" style="text-align: <?php echo e(Session::get('direction') === "rtl" ? 'right' : 'left'); ?>;">
                        <h6 class="card-subtitle"><?php echo e(\App\CPU\translate('returned')); ?></h6>
                        <span class="card-title h3"><?php echo e($data['returned']); ?></span>
                    </div>
                    <span class="icon icon-sm icon-soft-secondary icon-circle ml-3">
            ...
            <div class="col-sm-6 col-lg-3 column-divider-sm">
                <div class="media flex-between align-items-center" style="cursor: pointer"
                    ...
                    <div class="media-body" style="text-align: <?php echo e(Session::get('direction') === "rtl" ? 'right' : 'left'); ?>;">
                        <h6 class="card-subtitle"><?php echo e(\App\CPU\translate('failed')); ?></h6>
                        <span
...
<?php /**PATH /home/mh/code/project.co/Tigatech/umkm-shop/resources/views/admin-views/partials/_dashboard-order-stats.blade.php ENDPATH**/ ?>