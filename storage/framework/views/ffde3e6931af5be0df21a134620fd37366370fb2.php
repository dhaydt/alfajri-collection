                            ...
                            <div class="w-100 d-flex">
                                <div class="flag">
                                    <img class="<?php echo e(Session::get('direction') === " rtl" ? 'ml-2' : 'mr-2'); ?>" width="20"
                                        src="<?php echo e(asset('public/assets/front-end')); ?>/img/flags/<?php echo e(strtolower($product->seller->shop->country)); ?>.png"
                    ...
                    <div class="seller_shop">
                        ...
                        <div
                            ...
                            <div class="w-100 d-flex">
                                <div class="flag">
                                    <img class="<?php echo e(Session::get('direction') === " rtl" ? 'ml-2' : 'mr-2'); ?>" width="20"
                                        src="<?php echo e(asset('public/assets/front-end')); ?>/img/flags/id.png" alt="Eng"
                                        style="width: 20px">
                                </div>
                                <span
                                    class="d-inline-block font-size-sm text-body align-middle mt-1 <?php echo e(Session::get('direction') === "
...
<?php echo $__env->make('layouts.front-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mh/code/project.co/Tigatech/umkm-shop/resources/views/web-views/products/details.blade.php ENDPATH**/ ?>