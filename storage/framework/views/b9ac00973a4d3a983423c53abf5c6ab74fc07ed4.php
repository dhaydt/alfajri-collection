...
<div class="card-header">
    <h5 class="card-header-title">
        <i class="tio-star"></i> <?php echo e(\App\CPU\translate('most_rated_products')); ?>
                        ...
                        <tr onclick="location.href='<?php echo e(route('admin.product.view',[$item['product_id']])); ?>'"
                            ...
                            <td scope="row">
                                <img height="35" style="border-radius: 5px"
                                     ...
                                     onerror="this.src='<?php echo e(asset('assets/back-end/img/160x160/img2.jpg')); ?>'"
...
<!-- End Body -->
<?php /**PATH /home/mh/code/Pak etek/alfajri/resources/views/admin-views/partials/_most-rated-products.blade.php ENDPATH**/ ?>