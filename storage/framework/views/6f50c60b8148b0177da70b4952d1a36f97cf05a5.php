...
<?php $__env->startPush('css_or_js'); ?>
    <link href="<?php echo e(asset('assets/back-end/css/tags-input.min.css')); ?>" rel="stylesheet">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page"><a
                        href="<?php echo e(route('admin.product.list', ['in_house', ''])); ?>"><?php echo e(\App\CPU\translate('Product')); ?></a></li>
                <li class="breadcrumb-item" aria-current="page"><?php echo e(\App\CPU\translate('Edit')); ?></li>
            </ol>
        </nav>
        ...
        <div class="row">
            <div class="col-md-12">
                <form class="product-form" action="<?php echo e(route('admin.product.update',$product->id)); ?>" method="post"
                            ...
                            <?php $__currentLoopData = json_decode($language); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="<?php echo e($lang != 'en'? 'd-none':''); ?> lang_form" id="<?php echo e($lang); ?>-form">
                                    ...
                                    <div class="form-group pt-4">
                                        <label class="input-label"><?php echo e(\App\CPU\translate('description')); ?>

                                            (<?php echo e(strtoupper($lang)); ?>)</label>
                                        <textarea name="description[]" style="display:none" class="textarea"
                                                  required><?php echo $translate[$lang]['description']??$product['details']; ?></textarea>
                                    </div>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <label for="name"><?php echo e(\App\CPU\translate('Label')); ?></label>
                                        <input type="text" name="label" class="form-control" value="<?php echo e($product['label']); ?>">
                                    </div>
                                    <div class="col-md-4">
                    ...
                    <div class="card mt-2 rest-part">
                        <div class="card-header">
                            <h4><?php echo e(\App\CPU\translate('Variation')); ?></h4>
                        </div>
                        <div class="card-body">
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        <img style="width: 100%" height="auto"
                                                             ...
                                                             src="<?php echo e(asset("storage/product/meta")); ?>/<?php echo e($product['meta_image']); ?>"
                                                             alt="Meta image">
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-6">
                                            <div class="card">
                                                <div class="card-body">
                                                    <img style="width: 100%" height="auto"
                                                         onerror="this.src='<?php echo e(asset('assets/front-end/img/image-place-holder.png')); ?>'"
                                                         src="<?php echo e(asset("storage/product/thumbnail")); ?>/<?php echo e($product['thumbnail']); ?>"
                                                         alt="Product image">
                                                </div>
                                            </div>
                                        </div>
...
<?php $__env->startPush('script_2'); ?>
    ...
    <script>
        ...
        var thumbnail = '<?php echo e(\App\CPU\ProductManager::product_image_path('thumbnail').'/'.$product->thumbnail??asset('assets/back-end/img/400x400/img2.jpg')); ?>';
        $(function () {
            if (imageCount > 0) {
...
<?php echo $__env->make('layouts.back-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mh/code/Pak etek/alfajri/resources/views/admin-views/product/edit.blade.php ENDPATH**/ ?>