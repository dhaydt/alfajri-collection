...
<main id="content" role="main" class="main">
    <div class="position-fixed top-0 right-0 left-0 bg-img-hero"
         style="height: 32rem; background-image: url(<?php echo e(asset('assets/admin')); ?>/svg/components/abstract-bg-4.svg);">
        <!-- SVG Bottom Shape -->
    ...
    <div class="container py-5 py-sm-7">
        ...
        <a class="d-flex justify-content-center mb-5" href="javascript:">
            <img class="z-index-2" src="<?php echo e(asset("storage/company/".$e_commerce_logo)); ?>" alt="Logo"
                 onerror="this.src='<?php echo e(asset('assets/back-end/img/400x400/img2.jpg')); ?>'"
                 style="width: 8rem;">
        </a>
...
<?php /**PATH /home/mh/code/Pak etek/alfajri/resources/views/admin-views/auth/login.blade.php ENDPATH**/ ?>