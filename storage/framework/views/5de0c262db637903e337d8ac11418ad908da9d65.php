                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12" style="padding-top: 20px">
                                    <center>
                                        ...
                                        onerror="this.src='<?php echo e(asset('assets/front-end/img/image-place-holder.png')); ?>'" src="<?php echo e(asset('storage/deal')); ?>/<?php echo e($deal['banner']); ?>" alt="banner image"/>
                                    </center>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.back-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mh/code/Pak etek/alfajri/resources/views/admin-views/deal/flash-update.blade.php ENDPATH**/ ?>