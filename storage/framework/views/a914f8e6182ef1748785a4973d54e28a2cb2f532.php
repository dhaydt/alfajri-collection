...
<meta property="og:image" content="<?php echo e(asset('storage/company')); ?>/<?php echo e($web_config['web_logo']->value); ?>" />
...
<meta property="twitter:card" content="<?php echo e(asset('storage/company')); ?>/<?php echo e($web_config['web_logo']->value); ?>" />
                     ...
                     <a href="<?php echo e($banner->url); ?>"
                        style="cursor: pointer;" class="w-100 h-100">
                         <img class="d-block footer_banner_img w-100 h-100"
                              onerror="this.src='<?php echo e(asset('assets/front-end/img/image-place-holder.png')); ?>'"
                              src="<?php echo e(asset('storage/banner')); ?>/<?php echo e($banner['photo']); ?>">
                     </a>
                 </div>
                    ...
                    <div class="text-center">
                        <a href="<?php echo e(route('products',['id'=> $brand['id'],'data_from'=>'brand','page'=>1])); ?>">
                            <div class="brand_div d-flex align-items-center justify-content-center">
                                <img
                                    onerror="this.src='<?php echo e(asset('assets/front-end/img/image-place-holder.png')); ?>'"
                                    src="<?php echo e(asset("storage/brand/$brand->image")); ?>" alt="<?php echo e($brand->name); ?>">
                            </div>
                        </a>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.front-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mh/code/Pak etek/alfajri/resources/views/web-views/home.blade.php ENDPATH**/ ?>