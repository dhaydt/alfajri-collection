            ...
            <form action="<?php echo e(route('admin.business-settings.update-info')); ?>" method="POST"
                            ...
                            <div class="card-header">
                                <div class="flex-between">
                                    ...
                                    <div class="<?php echo e(Session::get('direction') === "rtl" ? 'mr-1' : 'ml-1'); ?>"><small
                                            style="color: red"><?php echo e(\App\CPU\translate('Ratio')); ?> ( <?php echo e(\App\CPU\translate('6:1')); ?> )</small></div>
                                </div>
                            ...
                            <div class="card-body" style="padding: 20px">
                                <center>
                                    <img height="200" style="width: 100%" id="viewerShop"
                                         ...
                                         src="<?php echo e(asset('storage/shop')); ?>/<?php echo e(\App\CPU\Helpers::get_business_settings('shop_banner')); ?>">
                                </center>
                                <hr>
                            ...
                            <div class="card-body" style="padding: 20px">
                                <center>
                                    <img width="200" height="60" id="viewerWL"
                                         onerror="this.src='<?php echo e(asset('assets/front-end/img/image-place-holder.png')); ?>'"
                                         src="<?php echo e(asset('storage/company')); ?>/<?php echo e(\App\Model\BusinessSetting::where(['type' => 'company_web_logo'])->pluck('value')[0]); ?>">
                                </center>
                                <hr>
                                <div class="row pl-4 pr-4">
                                    <div class="col-12" style="text-align: left">
                            ...
                            <div class="card-body" style="padding: 20px">
                                <center>
                                    <img width="100" height="60" id="viewerML"
                                         onerror="this.src='<?php echo e(asset('assets/front-end/img/image-place-holder.png')); ?>'"
                                         src="<?php echo e(asset('storage/company')); ?>/<?php echo e(\App\Model\BusinessSetting::where(['type' => 'company_mobile_logo'])->pluck('value')[0]); ?>">
                                </center>
                                <hr>
                                <div class="row pl-4 pr-4">
                                    <div class="col-12" style="text-align: left">
                ...
                <div class="row" style="padding-bottom: 20px">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h5><?php echo e(\App\CPU\translate('Flash_Sale_Banner')); ?></h5>
                            ...
                            <div class="card-body" style="padding: 20px">
                                <center>
                                    <img width="233" id="viewerWFS"
                                         onerror="this.src='<?php echo e(asset('assets/front-end/img/image-place-holder.png')); ?>'"
                                         src="<?php echo e(asset('storage/company')); ?>/<?php echo e(\App\Model\BusinessSetting::where(['type' => 'flash_sale_banner'])->pluck('value')[0]); ?>">
                                </center>
                                <hr>
                                <div class="row pl-4 pr-4">
                                    <div class="col-12" style="text-align: left">
                                        <input type="file" name="flash_sale_banner" id="customFileUploadWFS"
                                               ...
                                               accept=".jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                        <label class="custom-file-label"
                                               for="customFileUploadWFS"><?php echo e(\App\CPU\translate('choose')); ?> <?php echo e(\App\CPU\translate('file')); ?></label>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card-body" style="padding: 20px">
                                <center>
                                    <img width="250" id="viewerWFL"
                                         onerror="this.src='<?php echo e(asset('assets/front-end/img/image-place-holder.png')); ?>'"
                                         src="<?php echo e(asset('storage/company')); ?>/<?php echo e(\App\Model\BusinessSetting::where(['type' => 'company_footer_logo'])->pluck('value')[0]); ?>">
                                </center>
                                <hr>
                                <div class="row pl-4 pr-4">
                                    <div class="col-12" style="text-align: left">
                            ...
                            <div class="card-body" style="padding: 20px">
                                <center>
                                    <img width="60" id="viewerFI"
                                         onerror="this.src='<?php echo e(asset('assets/front-end/img/image-place-holder.png')); ?>'"
                                         src="<?php echo e(asset('storage/company')); ?>/<?php echo e(\App\Model\BusinessSetting::where(['type' => 'company_fav_icon'])->pluck('value')[0]); ?>">
                                </center>
                                <hr>
                                <div class="row pl-4 pr-4">
                                    <div class="col-12" style="text-align: left">
...
<?php echo $__env->make('layouts.back-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mh/code/Pak etek/alfajri/resources/views/admin-views/business-settings/website-info.blade.php ENDPATH**/ ?>