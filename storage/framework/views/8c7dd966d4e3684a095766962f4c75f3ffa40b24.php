...
<div class="row mb-4 d-none d-md-flex" style="max-height: 400px">
    <div class="banner col-md-3 col-6">
        <a href="/" class="h-100">
            <div class="bandiv">
                <img src="<?php echo e(asset("storage/company")."/".$web_config['flash_banner']->value); ?>" alt="">
            </div>
        </a>
    </div>
...
<?php /**PATH /home/mh/code/Pak etek/alfajri/resources/views/web-views/partials/_flash-deal.blade.php ENDPATH**/ ?>