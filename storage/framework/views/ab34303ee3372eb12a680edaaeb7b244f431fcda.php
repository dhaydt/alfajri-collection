            ...
            <div class="navbar-brand-wrapper">
                ...
                <a class="navbar-brand" href="<?php echo e(route('admin.dashboard.index')); ?>" aria-label="">
                    ...
                    <img class="navbar-brand-logo-mini" style="max-height: 42px;"
                         onerror="this.src='<?php echo e(asset('assets/front-end/img/image-place-holder.png')); ?>'"
                         src="<?php echo e(asset("storage/company/$e_commerce_logo")); ?>"
                         alt="Logo">
                </a>
                <!-- End Logo -->
            </div>
...
<?php /**PATH /home/mh/code/Pak etek/alfajri/resources/views/layouts/back-end/partials/_header.blade.php ENDPATH**/ ?>