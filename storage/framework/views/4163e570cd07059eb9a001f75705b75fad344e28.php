...
<?php $__env->startSection('content'); ?>
    <div class="container for-container rtl" style="text-align: <?php echo e(Session::get('direction') === "rtl" ? 'right' : 'left'); ?>;">
        <h2 class="text-center mt-3 headerTitle"><?php echo e(\App\CPU\translate('Privacy policy')); ?></h2>
...
<?php echo $__env->make('layouts.front-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mh/code/project.co/Tigatech/umkm-shop/resources/views/web-views/privacy-policy.blade.php ENDPATH**/ ?>