...
<?php $__env->startSection('content'); ?>
    <div class="container pb-5 mb-2 mt-3 rtl" style="text-align: <?php echo e(Session::get('direction') === "rtl" ? 'right' : 'left'); ?>;" id="cart-summary">
       <div class="feature_header">
        <span><?php echo e(\App\CPU\translate('fill_address')); ?></span>
            ...
            <div class="modal-dialog  modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <div class="row">
                            <div class="col-md-12">
                                <h5 class="modal-title font-name "><?php echo e(\App\CPU\translate('add_new_address')); ?></h5>
                            </div>
                        </div>
                    </div>
                    <div class="modal-body">
                        <form action="<?php echo e(route('address-store-first')); ?>" method="post">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="tab-content">
                                <div id="home" class="container tab-pane active"><br>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input class="form-control" type="text" value="<?php echo e(old('name')); ?>" id="name" name="name" required>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="address"><?php echo e(\App\CPU\translate('address')); ?></label>
                                            <input class="form-control" type="text" value="<?php echo e(old('address')); ?>" id="address" name="address"
                                                required>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input class="form-control" type="number" id="zip" name="zip" value="<?php echo e(old('zip')); ?>" required>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="country"><?php echo e(\App\CPU\translate('country')); ?></label>
                                            <select id="country" name="country" class="form-control" value="<?php echo e(old('country')); ?>">
                                    ...
                                    <div class="form-row prov-inter">
                                        <div class="form-group col-md-6">
                                            <label for="state"><?php echo e(\App\CPU\translate('State_/_Province')); ?></label>
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="district"><?php echo e(\App\CPU\translate('District')); ?></label>
                                    ...
                                    <div class="form-row prov-indo d-none">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="form-control" name="state">
                                                ...
                                                <option value="<?php echo e($p['province_id'].','. $p['province']); ?>"
                                                    provincename="<?php echo e($p['province']); ?>">
                                                    <?php echo e($p['province']); ?>
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="firstName"><?php echo e(\App\CPU\translate('Phone')); ?></label>
                                            <input class="form-control" type="number" id="phone" name="phone" value="<?php echo e(old('phone')); ?>">
                                        </div>
                                    </div>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-primary"><?php echo e(\App\CPU\translate('Continue')); ?>

                                        <?php echo e(\App\CPU\translate('Checkout')); ?> </button>
                                </div>
                            </div>
                        </form>
                    </div>
...
<?php echo $__env->make('layouts.front-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mh/code/project.co/Tigatech/umkm-shop/resources/views/web-views/addAddress.blade.php ENDPATH**/ ?>