<?php $__env->startSection('message'); ?>
    ...
    <div class="container ">
        ...
        <div class="col-md-6 for-margin">
            <div class="for-image">
                <img style="" src="<?php echo e(asset("storage/app/png/404.png")); ?>" alt="">
            </div>
...
<?php echo $__env->make('errors::minimal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mh/code/Pak etek/alfajri/resources/views/errors/404.blade.php ENDPATH**/ ?>