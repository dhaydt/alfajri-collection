                                ...
                                <div class="col-md-12">
                                    <center>
                                        <img style="width: auto;border: 1px solid; border-radius: 10px; max-height:200px;" id="viewer"
                                            src="<?php echo e(asset('assets\back-end\img\1920x400\img2.jpg')); ?>" alt="banner image"/>
                                    </center>
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.back-end.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mh/code/Pak etek/alfajri/resources/views/admin-views/deal/flash-index.blade.php ENDPATH**/ ?>