                    ...
                    <div class="grid-card" style="min-height: 170px">
                        ...
                        <div class="text-center mt-3">
                            <img style="border-radius: 50%;width: 60px;height: 60px;border:2px solid #80808082;"
                                 onerror="this.src='<?php echo e(asset('assets/back-end/img/160x160/img1.jpg')); ?>'"
                                 src="<?php echo e(asset('storage/shop/'.$shop->image??'')); ?>">
                        </div>
...
<!-- End Body -->
<?php /**PATH /home/mh/code/Pak etek/alfajri/resources/views/admin-views/partials/_top-store-by-order.blade.php ENDPATH**/ ?>