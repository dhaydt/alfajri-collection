        ...
        <div class="row">
            <div class="col-md-12" id="banner-btn">
                ...
                <button id="secondary-banner-add"
                        ...
                        class="tio-add-circle"></i> {{ \App\CPU\translate('add_product')}}</button>
            </div>
        </div>
        <!-- Content Row -->
        <div class="row pt-4" id="main-banner" style="display: none;text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{route('admin.linktreeProduct.store')}}" method="post" enctype="multipart/form-data"
                              class="banner_form">
                            @csrf
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <label for="name">{{ \App\CPU\translate('Product')}}</label><span
        ...
        <div class="row pt-4" id="secondary-banner" style="display: none">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="banner_form" action="{{route('admin.linktreeProduct.store')}}" method="post"
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <label for="name">{{ \App\CPU\translate('Image Product')}}</label><span
                                            class="badge mt-2 badge-soft-danger">( {{ \App\CPU\translate('Ex')}} 1:1 )</span>
                                        <br>
                                        <div class="custom-file" style="text-align: left">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img width="80"
                                                 ...
                                                 src="{{asset('storage/linktree')}}/{{$banner['image']}}">
                                        </td>
                                        <td>
                                            <div class="dropdown">
...
@push('script')
    ...
    <script>
        ...
        $(document).on('click', '.delete', function () {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: "{{route('admin.linktreeProduct.delete')}}",
                        method: 'POST',
                        data: {id: id},
                        success: function () {
        ...
        $(document).on('click', '.edit', function () {
            ...
            $.ajax({
                url: "{{route('admin.linktreeProduct.edit')}}",
                method: 'POST',
                data: {id: id},
                success: function (data) {
                    $('.banner_form').attr('action', "{{route('admin.linktreeProduct.update')}}");
                    console.log(data);
                        $('#secondary-banner').show();
                        $('#banner-table').hide();
                        // $('#addfooter').hide();
                        ...
                        $('#sosmedName').val(data.title);
                        $('#sosmedLink').val(data.link);
                        $('#footerurl').siblings('#id').val(data.id);
                        $('#fbImageviewer').attr('src', "{{asset('storage/linktree')}}" + "/" + data.image);
                        $('#cate-table').hide();
        ...
        $('#update').on('click', function () {
            ...
            $.ajax({
                url: "{{route('admin.linktreeProduct.update')}}",
                method: 'POST',
                data: {
                    id: id,
                    link: link,
